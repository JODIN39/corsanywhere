...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['https://mlb18.theshownation.com/api/v1/listings.json?type=MLB_Card&page=1'],            // If non-empty, requests not from an origin in this list will be blocked.
